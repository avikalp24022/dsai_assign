...
Rules:
1. Add the main task based on intent
2. Keep plan minimal (1-3 steps usually)
3. For "transcribe": ["transcribe"]
4. For "summarize": ["summarize"]
5. For "sentiment": ["sentiment_analysis"]
6. For "code_explain": ["code_explanation"]
7. For "general conversation": [conversational_response]

Return JSON array: ["task1"]
> Do not include explanations, markdown, or text outside JSON.**
"""
